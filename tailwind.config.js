  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'white-blue-glow': '0 0 25px -2px rgba(186, 230, 253, 0.28)',
        'white-blue-glow-lg': '0 0 45px -2px rgba(186, 230, 253, 0.45)',
        'blue-glow': '0 0 20px -3px rgba(29, 78, 216, 0.35)',
        'command-card': '0 4px 20px -2px rgba(7, 12, 30, 0.08)',
        'command-card-dark': '0 4px 28px -2px rgba(0, 0, 0, 0.7), 0 0 15px -3px rgba(186, 230, 253, 0.06)',
      },
      animation: {
