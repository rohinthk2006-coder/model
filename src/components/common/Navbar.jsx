      ...
      <div className="px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to="/" className="flex items-center gap-2.5 group">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-blue-700 via-blue-600 to-cyan-400 flex items-center justify-center shadow-blue-glow text-white font-black text-lg tracking-wider">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="relative" ref={profileRef}>
            ...
            >
              <div className="w-8 h-8 rounded-lg overflow-hidden bg-blue-600 border border-cyan-400/40 shrink-0">
                <img
            ...
            {showProfileMenu && (
              <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-navy-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-navy-700 py-2 z-50 animate-fade-in text-left">
                <div className="px-4 py-3 border-b border-slate-100 dark:border-navy-800">
                  ...
                  <span className="inline-block mt-2 text-[10px] font-semibold px-2 py-0.5 rounded-full bg-blue-500/10 text-blue-600 dark:text-cyan-400 border border-blue-500/20">
