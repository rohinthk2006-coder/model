      ...
      <div className="px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to="/" className="flex items-center gap-2.5 group">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-blue-700 via-blue-600 to-blue-500 dark:from-emerald-700 dark:via-emerald-600 dark:to-teal-400 flex items-center justify-center shadow-blue-glow dark:shadow-green-glow text-white font-black text-lg tracking-wider">
        ...
        <div className="relative flex-1 max-w-md hidden md:block" ref={searchRef}>
          <form onSubmit={handleSearchSubmit}>
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 text-xs rounded-xl bg-slate-100 dark:bg-navy-950/80 border border-slate-200 dark:border-navy-700 text-slate-800 dark:text-slate-200 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all"
              />
            </div>
          </form>
          ...
          {showSearchSuggestions && searchQuery.length > 0 && (
            <div className="absolute top-full mt-1.5 left-0 w-full bg-white dark:bg-navy-900 rounded-xl shadow-xl border border-slate-200 dark:border-navy-700 p-2 z-50 animate-fade-in">
              ...
              >
                <BookOpen className="w-3.5 h-3.5 text-blue-600 dark:text-cyan-500" />
              ...
              <button
                ...
                className="w-full text-left flex items-center gap-2 px-2 py-2 text-xs rounded-lg hover:bg-slate-100 dark:hover:bg-navy-800 text-slate-800 dark:text-slate-200"
              >
                <Sparkles className="w-3.5 h-3.5 text-blue-600 dark:text-amber-500" />
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="hidden sm:flex items-center p-0.5 rounded-xl bg-slate-100 dark:bg-navy-950 border border-slate-200 dark:border-navy-700 text-xs font-medium">
            <button
              ...
              className={`px-2.5 py-1 rounded-lg transition-all ${
                userRole === 'employee'
                  ? 'bg-blue-600 dark:bg-emerald-600 text-white font-semibold shadow-sm'
            ...
            <button
              ...
              className={`px-2.5 py-1 rounded-lg transition-all ${
                userRole === 'manager'
                  ? 'bg-blue-700 dark:bg-teal-600 text-white font-semibold shadow-sm'
                  : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white'
              }`}
            >
              Manager
          ...
          <div className="relative" ref={notifRef}>
            ...
            >
              ...
              {unreadCount > 0 && (
                <span className="absolute top-1.5 right-1.5 w-2 h-2 rounded-full bg-blue-600 dark:bg-cyan-400 ring-2 ring-white dark:ring-navy-900 animate-pulse" />
              )}
            </button>
              ...
              <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-white dark:bg-navy-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-navy-700 overflow-hidden z-50 animate-fade-in">
                <div className="p-4 border-b border-slate-100 dark:border-navy-800 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    {unreadCount > 0 && (
                      <span className="bg-blue-50 text-blue-600 dark:bg-cyan-500/20 dark:text-cyan-400 text-[11px] font-semibold px-2 py-0.5 rounded-full">
                        {unreadCount} new
                      </span>
                    )}
                  </div>
                  {unreadCount > 0 && (
                    <button
                      ...
                      className="text-xs text-blue-600 dark:text-cyan-400 hover:underline flex items-center gap-1 font-medium"
                    >
          ...
          <div className="relative" ref={profileRef}>
            ...
            >
              <div className="w-8 h-8 rounded-lg overflow-hidden bg-blue-600 dark:bg-emerald-600 border border-blue-400/40 dark:border-emerald-400/40 shrink-0">
                <img
            ...
            {showProfileMenu && (
              <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-navy-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-navy-700 py-2 z-50 animate-fade-in text-left">
                <div className="px-4 py-3 border-b border-slate-100 dark:border-navy-800">
                  ...
                  <span className="inline-block mt-2 text-[10px] font-semibold px-2 py-0.5 rounded-full bg-blue-50 text-blue-600 border border-blue-200 dark:bg-emerald-500/10 dark:text-emerald-400 dark:border-emerald-500/20">
                ...
                <div className="py-1">
                  ...
                  >
                    <User className="w-3.5 h-3.5 text-blue-600 dark:text-emerald-500" />
                  ...
                  <Link
                    ...
                    className="flex items-center gap-2 px-4 py-2 text-xs text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-navy-800"
                  >
                    <Sparkles className="w-3.5 h-3.5 text-blue-600 dark:text-cyan-500" />
                  ...
                  <Link
                    ...
                    className="flex items-center gap-2 px-4 py-2 text-xs text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-navy-800"
                  >
                    <Award className="w-3.5 h-3.5 text-blue-600 dark:text-emerald-500" />
                ...
                <div className="border-t border-slate-100 dark:border-navy-800 pt-1 pb-1">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-between px-4 py-2 text-xs text-blue-600 dark:text-cyan-400 hover:bg-slate-50 dark:hover:bg-navy-800 font-semibold"
                  >
