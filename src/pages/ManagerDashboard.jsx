...
export const ManagerDashboard = () => {
  ...
  return (
    <div className="space-y-7 animate-fade-in">
                ...
                >
                  ...
                  <td className="py-3 px-3">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="w-14 bg-slate-200 dark:bg-navy-950 h-1.5 rounded-full overflow-hidden">
                        <div
                          className="bg-blue-600 dark:bg-emerald-600 h-full rounded-full"
                  ...
                  <td className="py-3 px-3 text-right">
                    <button
                      ...
                      className="px-3 py-1.5 rounded-lg border border-slate-200 dark:border-navy-700 hover:bg-slate-100 dark:hover:bg-navy-700 text-xs font-semibold text-blue-600 dark:text-emerald-400 transition-all inline-flex items-center gap-1 btn-command"
                    >
      ...
      {selectedEmployee && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 dark:bg-navy-950/80 backdrop-blur-sm animate-fade-in">
          <div className="w-full max-w-xl bg-white dark:bg-navy-900 rounded-2xl shadow-2xl border border-blue-300 dark:border-emerald-500/30 overflow-hidden text-slate-900 dark:text-white p-6 sm:p-7 space-y-5">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-navy-800">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-blue-600 dark:bg-emerald-600 overflow-hidden shrink-0 border border-blue-400/40 dark:border-emerald-400/40">
            ...
            <div className="grid grid-cols-3 gap-3 text-xs text-center">
              <div className="p-3 rounded-xl bg-slate-50 dark:bg-navy-950 border border-slate-200 dark:border-navy-800">
                ...
                <p className="font-bold text-blue-600 dark:text-emerald-500 text-lg mt-0.5 font-mono">
            ...
            <div className="p-4 rounded-xl bg-blue-50/70 dark:bg-navy-950/80 border border-blue-100 dark:border-navy-800 space-y-2 text-xs">
            ...
            <div className="pt-2 flex items-center justify-end gap-2.5">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl bg-blue-600 hover:bg-blue-700 dark:bg-emerald-600 dark:hover:bg-emerald-500 text-white text-xs font-bold transition-all btn-command"
              >
