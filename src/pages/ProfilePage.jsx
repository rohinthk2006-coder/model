    ...
    <div className="space-y-7 animate-fade-in max-w-5xl mx-auto">
      ...
      <div className="glass-card rounded-2xl p-6 sm:p-8 border border-slate-200 dark:border-navy-800 shadow-xl relative overflow-hidden">
        ...
        <div className="relative pt-12 flex flex-col sm:flex-row items-start sm:items-end justify-between gap-5">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <div className="w-24 h-24 rounded-2xl overflow-hidden bg-blue-600 border-4 border-white dark:border-navy-900 shadow-xl shrink-0">
              <img
          ...
          {certificates.map((cert) => (
            ...
            >
              <div className="flex items-start gap-3">
                <div className="p-2.5 rounded-xl bg-blue-500/10 text-blue-600 dark:text-cyan-400 shrink-0 mt-0.5">
      ...
      {selectedCert && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-navy-950/75 backdrop-blur-sm animate-fade-in">
          <div className="w-full max-w-xl bg-white dark:bg-navy-900 rounded-2xl shadow-2xl border-2 border-cyan-500/40 p-6 sm:p-8 space-y-6 text-slate-900 dark:text-white text-center relative">
            <button
            ...
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-navy-950 border border-slate-200 dark:border-navy-800 space-y-2">
              ...
              <h3 className="text-lg font-bold text-blue-600 dark:text-cyan-400">
                {currentUser.name}
              </h3>
            ...
            <div className="pt-2 flex items-center justify-center gap-3">
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold shadow-sm flex items-center gap-1.5"
              >
